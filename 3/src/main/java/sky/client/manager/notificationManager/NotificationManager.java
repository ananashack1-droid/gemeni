...
public class NotificationManager implements IMinecraft {
    ...
    public void add(String message, NotificationType notificationType, int i) {
    }

    public void add(String antiBot, NotificationType notificationType, String message, int time) {
    }

    public void add(String message, int i) {
    }
}
