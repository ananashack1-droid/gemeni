package sky.client.manager.themeManager;
...
public class StyleManager implements IMinecraft {
    ...
    public class ClientManager implements ClientModInitializer {
        @Override
        public void onInitializeClient() {
            // Инициализация менеджера тем ДО загрузки чего-либо еще
            Manager.STYLE_MANAGER = new StyleManager();
            Manager.STYLE_MANAGER.init(); // Или как у тебя называется метод запуска

            // ... остальная инициализация (команды, конфиги)
        }
    }
