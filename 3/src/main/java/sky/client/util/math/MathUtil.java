...
public class MathUtil implements IMinecraft {
    ...
    // Добавь в конец класса MathUtil
    ...
    public static boolean isInRegion(double mouseX, double mouseY, float x, float y, int width, int height) {
        return mouseX >= x && mouseX <= x + width && mouseY >= y && mouseY <= y + height;
    }

    public static boolean isInRegion(int mouseX, int mouseY, float x, float y, float width, int height) {
        return mouseX >= x && mouseX <= x + width && mouseY >= y && mouseY <= y + height;
    }

    public static boolean isInRegion(double mouseX, double mouseY, float x, float y, float width, int height) {
        return mouseX >= x && mouseX <= x + width && mouseY >= y && mouseY <= y + height;
    }
    // В файл sky/client/util/math/MathUtil.java добавь:
