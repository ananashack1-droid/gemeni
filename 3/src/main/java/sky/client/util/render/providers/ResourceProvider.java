package sky.client.util.render.providers;
...
public final class ResourceProvider {
    ...
    public static final Identifier glow = Identifier.of("exosware", "images/particles/glow.png");

    public static final Identifier menubg = Identifier.of("exosware", "images/gui/bg2.png");
	...
	private static Identifier getGlass(String name) { return Identifier.of("exosware", "core/glass/" + name);}
